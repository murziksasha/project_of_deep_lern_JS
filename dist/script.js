...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horicantal', '.main-prev-btn', '.main-next-btn');
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["checkEngTextInputs"])('[name="email"]');
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_9__["default"])('.accordion-heading', '.accordion-block'); //only first arg need for second impementating way
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var sum = 0; //initial summ of feature price

  var calcFunc = function calcFunc() {
    sum = Math.round(+sizeBlock.value * +materialBlock.value + +optionsBlock.value);

    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = 'Пожалуйста выберите матреиал картины!';
    } else if (promocodeBlock.value == 'IWANTPOPART') {
      console.log('i am here');
      resultBlock.textContent = Math.round(sum * 0.7); //30% minus from price by promocode
    } else {
...
/*!*******************************************!*\
  !*** ./src/js/modules/checkTextInputs.js ***!
  \*******************************************/
/*! exports provided: checkEngTextInputs, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkEngTextInputs", function() { return checkEngTextInputs; });
...
var checkEngTextInputs = function checkEngTextInputs(selector) {
  var txtInputs = document.querySelectorAll(selector);
  txtInputs.forEach(function (input) {
    input.addEventListener('keypress', function (e) {
...
var drop = function drop() {
  // drag * звездочка это события к-ые срабатвают на элементе который мы перетаскиваем
  // dragend *
  ...
  var fileInputs = document.querySelectorAll('[name="upload"]'); //создаем массив событий
  ...
  function highlight(item) {
    //после перетаскиваня подсвечивает блок
...
var filter = function filter() {
  ...
  var listenerForAction = function listenerForAction(btn, elemCollection) {
    btn.addEventListener('click', function () {
      typeFilter(elemCollection);
    });
  };
  ...
  listenerForAction(btnAll, markAll);
  listenerForAction(btnLovers, markLovers);
  listenerForAction(btnChef, markChef);
  listenerForAction(btnGirl, markGirl);
  listenerForAction(btnGuy, markGuy);
  listenerForAction(btnGrandmother);
  listenerForAction(btnGranddad);
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var api; //vaiable of dynemic path to where sending data
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        setTimeout(function () {
          ...
          item.classList.add('fadeInUp'); // document.body.style.overflow = '';
        }, 5000);
      });
    });
  });
...
var modals = function modals() {
  ...
  function hiddenCloser(bodyToHide) {
    ...
    bodyToHide.style.display === 'block' ? document.body.style.overflow = 'hidden' : document.body.style.overflow = '';
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); //download cards without server require
  // cards.forEach(card => {
  ...
  //   btn.remove();
  // });
  //download cards from server from db.json

  btn.addEventListener('click', function (e) {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('assets/db.json') //так обращаются не используя сервер json-server
    .then(function (res) {
...
var sliders = function sliders(slides, dir, prev, next) {
  var slideIndex = 1,
      paused = false; //переменная отвечающая за переключение слайдов
